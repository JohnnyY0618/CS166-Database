...
public class EmbeddedSQL {
   ...
   public static void Query2(EmbeddedSQL esql){
      ...
      // ...
      try{
         String query = "SELECT S.sname, COUNT(*) FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid GROUP BY S.sid HAVING COUNT(*)>2;";
   ...
   public static void Query3(EmbeddedSQL esql){
      ...
      // ...
      try{
         String query = "SELECT S.sname, COUNT(*) FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid AND S.sid IN (SELECT S.sid FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid AND P.color='Green' EXCEPT SELECT S.sid FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid AND P.color!='Green') GROUP BY S.sid;";
   ...
   public static void Query4(EmbeddedSQL esql){
      ...
      // ...
      try{
         String query = "SELECT S.sname, MAX(C.cost) FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid AND S.sid IN (SELECT S.sid FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid AND P.color='Green' INTERSECT SELECT S.sid FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid AND P.color!='Red')GROUP BY S.sid;";
   ...
   public static void Query6(EmbeddedSQL esql){
      ...
      // ...
      try{
         String query = "SELECT S.address FROM Suppliers S, Parts P, Catalog C WHERE S.sid=C.sid AND C.pid=P.pid AND P.panme =  ";
